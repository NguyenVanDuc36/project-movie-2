            ...
            <footer className="px-4 pt-5 divide-y bg-coolGray-100 text-coolGray-800">
                <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                    <div className="lg:w-1/3">
                        ...
                        <div className="wrapper m-0 mt-3">
                                        <a target="_blank" href="https://www.facebook.com/profile.php?id=100048916264654" className="icon facebook">
                                        ...
                                        <a href="https://www.youtube.com/" target="_blank" className="icon youtube">
