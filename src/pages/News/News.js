...
export default function News(props) {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img  className="object-cover" style={{width:'500px',height:'500px'}} src="https://themes.themewild.com/vidstream/assets/images/top-10/01.jpg" />
    ...
    <div className="hidden py-2 xl:col-span-3 lg:col-span-4 md:hidden lg:block">
      ...
      <div className="flex flex-col divide-y divide-coolGray-300">
        <div className="flex px-1 py-4">
          <img  className="flex-shrink-0 object-cover w-20 h-20 mr-4 bg-coolGray-500" src="https://themes.themewild.com/vidstream/assets/images/favorite/01.jpg" />
          <div className="flex flex-col flex-grow">
            <div  className="font-serif text-gray-200 hover:underline">Aenean ac tristique lorem, ut mollis dui.</div>
            <div className="mt-auto text-xs text-gray-200">5 minutes ago
        ...
        <div className="flex px-1 py-4">
          <img  className="flex-shrink-0 object-cover w-20 h-20 mr-4 bg-coolGray-500" src="https://themes.themewild.com/vidstream/assets/images/favorite/02.jpg" />
          <div className="flex flex-col flex-grow">
        ...
        <div className="flex px-1 py-4">
          <img className="flex-shrink-0 object-cover w-20 h-20 mr-4 bg-coolGray-500" src="https://themes.themewild.com/vidstream/assets/images/favorite/03.jpg" />
          <div className="flex flex-col flex-grow">
            <p  className="font-serif text-gray-200 hover:underline">Aenean ac tristique lorem, ut mollis dui.</p>
            <div className="mt-auto text-xs text-gray-200">5 minutes ago
              <a href="#" className="block text-green-500 lg:ml-2 lg:inline hover:underline">Politics</a>
        ...
        <div className="flex px-1 py-4">
          <img className="flex-shrink-0 object-cover w-20 h-20 mr-4 bg-coolGray-500" src="https://themes.themewild.com/vidstream/assets/images/favorite/04.jpg" />
          <div className="flex flex-col flex-grow">
            <p  className="font-serif text-gray-200 hover:underline">Aenean ac tristique lorem, ut mollis dui.</p>
            <div className="mt-auto text-xs text-gray-200">5 minutes ago
              <a href="#" className="block text-green-500 lg:ml-2 lg:inline hover:underline">Politics</a>
                        ...
                        <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-5">
                            ...
                            <article className="flex flex-col blog-home bg-coolGray-50">
                                <a href="#" aria-label="Te nulla oportere reprimique his dolorum">
                                    <img style={{ height: '260px' }} className="object-cover  img-fuild " src="./img/100.jpg" />
                                    ...
                                    <div className="overlay2 text-light text-center text-2xl" style={{ backgroundColor: '#ff0000' }}>
                                        <i className="fas fa-play i-icon"></i><br />
                                        <i className="fas fa-plus  i-icon"></i><br />
                                        <i className="fas fa-heart  i-icon"></i><br />
                                    </div>
                                </a>
                            ...
                            <article className="flex flex-col blog-home bg-coolGray-50">
                                <a href="#" aria-label="Te nulla oportere reprimique his dolorum">
                                    <img style={{ height: '260px' }} className="object-cover  img-fuild "  src="./img/banner-2.jpg" />
                                    <div className="overlay" >
                                        <div className="ml-2 mt-3" >
                                            <span style={{ width: '65px', color: 'black' }} className="bg-warning text-xs  px-2 py-1  rounded-md">Premium</span>
                                        </div>
                            ...
                            <article className="flex flex-col blog-home bg-coolGray-50">
                                <a href="#" aria-label="Te nulla oportere reprimique his dolorum">
                                    <img style={{ height: '260px' }} className="object-cover  img-fuild "  src="./img/beaty-beast.jpg" />
                                    <div className="overlay" >
                                        <div className="ml-2 mt-3" >
                                            <span style={{ width: '65px', color: 'black' }} className="bg-warning text-xs  px-2 py-1  rounded-md">Premium</span>
                                        </div>
                            ...
                            <article className="flex flex-col blog-home bg-coolGray-50">
                                <a href="#" aria-label="Te nulla oportere reprimique his dolorum">
                                    <img style={{ height: '260px' }} className="object-cover  img-fuild " src="./img/banner-4.jpg" />
                                    <div className="overlay" >
                                        <div className="ml-2 mt-3" >
                                            <span style={{ width: '65px', color: 'black' }} className="bg-warning text-xs  px-2 py-1  rounded-md">Premium</span>
                                        </div>
                ...
                <section className="mt-10 mb-10 blog-2 sm:mt-6 bg-coolGray-100 text-coolGray-800">
                    <div className="container px-6 mx-auto space-y-8">
                        <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
                            <article className="flex flex-col blog-home bg-coolGray-50">
                                <a href="#" aria-label="Te nulla oportere reprimique his dolorum">
                                    <img style={{ height: '330px' }} className="object-cover  img-fuild "  src="./img/banner-5.jpg" />
                                    <div className="overlay" >
                                        <div className="ml-2 mt-3" >
                                            <span style={{ width: '65px', color: 'black' }} className="bg-warning text-xs  px-2 py-1  rounded-md">Premium</span>
                                        </div>
                            ...
                            <article className="flex flex-col blog-home bg-coolGray-50">
                                <a href="#" aria-label="Te nulla oportere reprimique his dolorum">
                                    <img style={{ height: '330px' }} className="object-cover  img-fuild " src="./img/star-war.jpg" />
                                    <div className="overlay" >
                                        <div className="ml-2 mt-3" >
                                            <span style={{ width: '65px', color: 'black' }} className="bg-warning text-xs  px-2 py-1  rounded-md">Premium</span>
                                        </div>
                            ...
                            <article className="flex flex-col blog-home bg-coolGray-50">
                                <a href="#" aria-label="Te nulla oportere reprimique his dolorum">
                                    <img style={{ height: '330px' }} className="object-cover  img-fuild "  src="./img/banner-7.jpg" />
                                    <div className="overlay" >
                                        <div className="ml-2 mt-3" >
                                            <span style={{ width: '65px', color: 'black' }} className="bg-warning text-xs  px-2 py-1  rounded-md">Premium</span>
                                        </div>
                            ...
                            <article className="flex flex-col blog-home bg-coolGray-50">
                                <a href="#" aria-label="Te nulla oportere reprimique his dolorum">
                                    <img style={{ height: '330px' }} className="object-cover  img-fuild "src="./img/banner-8.jpg" />
                                    <div className="overlay" >
                                        <div className="ml-2 mt-3" >
                                            <span style={{ width: '65px', color: 'black' }} className="bg-warning text-xs  px-2 py-1  rounded-md">Premium</span>
                                        </div>
