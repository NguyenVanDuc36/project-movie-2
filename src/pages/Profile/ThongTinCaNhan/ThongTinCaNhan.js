                        ...
                        <TabPane tab="Thông tin người dùng" key="1">
                            <div className="grid grid-cols-2 pt-10" style={{ width: '70%', margin: '0 auto' }}>
                                <div className="content" >
                                    <h1><i className="far i-item fa-user-circle"></i>Tài Khoản : <span>{thongTinNguoiDung.taiKhoan}</span> </h1>
                                    <h1><i className="fas  i-item fa-at"></i>Email : <span>{thongTinNguoiDung.email}</span> </h1>
                                    <h1><i className="fas  i-item fa-phone-volume"></i>Số điện thoại : <span>{thongTinNguoiDung.soDT}</span>  </h1>
                                </div>
                                <div>
                                    <h1><i className="fas  i-item fa-qrcode"></i>Mã nhóm : <span>{thongTinNguoiDung.maNhom}</span> </h1>
                                    <h1><i className="fas  i-item fa-file-signature"></i>Họ và tên : <span>{thongTinNguoiDung.hoTen}</span>  </h1>
                                    <h1><i className="fas  i-item fa-user-edit"></i>Loại người dùng : <span>{thongTinNguoiDung.maLoaiNguoiDung}</span>  </h1>
                                </div>
                            </div>
                        </TabPane>
