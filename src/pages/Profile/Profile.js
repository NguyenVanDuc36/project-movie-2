        ...
        <Menu>
            ...
            <Menu.Item>
                <a onClick={() => {
                    ...
                    <div className="flex border-b-2 p-3" >
                        <i style={{ height: '50px', fontSize: '25px', width: '50px', borderRadius: '50%', backgroundColor: '#e4e6eb', lineHeight: '50px' }} classNamelass="fas mr-2 text-center item-i fa-sign-out-alt"></i ><span className="text-lg font-medium" >Đăng xuất</span>
                    </div>
                </a>
            </Menu.Item>
