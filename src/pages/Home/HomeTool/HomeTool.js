    ...
    <div >
      <div className="home-tool" >
        <Tabs tabBarExtraContent={operations} defaultActiveKey="1" onChange={callback}>
          <TabPane tab={<div className="tab-logo"><i className="far fa-file-video"></i><span> MOVIE</span></div>} key="1">
            <div className="row tab-pane" >

              <div className="col-3 flex items-end" >
                <div className="form-group relative" >
                  <form onSubmit={formik.handleSubmit} >
                    <button type="submit" className="absolute" style={{ color: '#90a5e8' }}  ><i className="fas fa-search"></i></button>
          ...
          <TabPane tab={<div className="tab-logo"><i className="far fa-file-video"></i><span> SPORT</span></div>} key="2">
            <div className="row tab-pane" >
          ...
          <TabPane tab={<div className="tab-logo"><i className="far fa-file-video"></i><span> LIVE</span></div>} key="3">
            <div className="row tab-pane" >
